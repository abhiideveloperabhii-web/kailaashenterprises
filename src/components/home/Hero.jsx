    ...
    <section className="relative pt-3 pb-4 sm:pt-4 sm:pb-6 md:pt-6 md:pb-8 overflow-hidden bg-gradient-to-b from-[#FAF8F3] via-[#FAF8F3] to-[#F3EEF8]">
      ...
      <Container size="large" className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-3.5 sm:space-y-4 md:space-y-5 text-center lg:text-left">
            
            {/* Top Micro Badge */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-white border border-[#E8E2EE] shadow-2xs text-[10.5px] sm:text-xs font-extrabold text-[#32105F] mx-auto lg:mx-0">
            ...
            <div className="space-y-1.5 sm:space-y-2 md:space-y-3">
              <h1 className="text-[26px] sm:text-4xl md:text-5xl lg:text-[48px] xl:text-[54px] font-black text-[#16131B] tracking-tight leading-[1.14]">
            ...
            <div className="pt-0.5 sm:pt-1">
              <div className="grid grid-cols-2 sm:flex sm:flex-row items-center justify-center lg:justify-start gap-2 sm:gap-2.5 md:gap-3">
                <Button
                  href={getWhatsAppUrl("Hello Kailaash Enterprises, I would like to consult about carpentry & interior services.")}
                  variant="whatsapp"
                  size="md"
                  icon="MessageSquare"
                  className="w-full sm:w-auto text-xs sm:text-sm py-2.5 sm:py-3 px-3.5 sm:px-4 shadow-sm active:scale-95"
                >
                  WhatsApp
                </Button>
            ...
            <div className="pt-0.5 sm:pt-1 flex flex-wrap items-center justify-center lg:justify-start gap-y-1.5 gap-x-3.5 sm:gap-x-5 text-[10.5px] sm:text-xs font-bold text-[#68636F]">
          ...
          <div className="lg:col-span-6 relative mt-2 sm:mt-4 lg:mt-0 flex justify-center lg:justify-end">
            <div className="bg-white p-2.5 sm:p-4 md:p-5 rounded-2xl sm:rounded-3xl border border-[#E8E2EE] shadow-lg sm:shadow-xl w-full max-w-[360px] sm:max-w-[440px] md:max-w-[480px] lg:max-w-[500px] xl:max-w-[540px] space-y-2.5 sm:space-y-3">
              ...
              <div className="grid grid-cols-2 gap-1.5 sm:gap-2.5 md:gap-3">
                ...
                <div className="relative rounded-xl sm:rounded-2xl overflow-hidden aspect-[4/3] group shadow-xs">
                  ...
                  <span className="absolute bottom-1.5 left-2 sm:bottom-2 sm:left-2.5 text-[10px] sm:text-xs md:text-sm font-black text-white drop-shadow-xs">
                    Modular Kitchens
                  </span>
                </div>
              ...
              <div className="p-2 sm:p-2.5 md:p-3 rounded-xl sm:rounded-2xl bg-[#170A2C] text-white flex items-center justify-between gap-2 sm:gap-3">
                <div className="flex items-center gap-2 sm:gap-2.5">
                  ...
                  <div>
                    <div className="text-[8.5px] sm:text-[10px] font-extrabold text-[#D7A72E] uppercase tracking-wider leading-none">
                      Complete Execution Team
                    </div>
                    <div className="text-[11px] sm:text-xs md:text-sm font-bold text-white/95 mt-0.5">
                      Khardi, Pune • Serving All Areas
                    </div>
                  </div>
                </div>

                <span className="text-[9.5px] sm:text-[10px] font-extrabold bg-white/10 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md sm:rounded-lg text-[#D7A72E] shrink-0 hidden xs:inline sm:inline">
                  100% Quality
                </span>
              </div>
