...
export default function Logo({
  ...
  return (
    <Link to="/" className={`inline-flex items-center gap-2.5 sm:gap-3 group select-none ${className}`}>
      ...
      {/* Vertical Divider */}
      <div className={`w-[1.5px] self-stretch rounded-full ${
        isDark ? 'bg-white/20' : 'bg-[#170A2C]/20'
      }`}></div>
      ...
      <div className="flex flex-col justify-center leading-none">
        ...
        {/* Optional Tagline */}
        {showTagline && (
          <span className={`text-[7px] sm:text-[7.5px] font-bold tracking-[0.14em] uppercase mt-1 hidden sm:block ${
